...
#define fann_linear_derive(steepness, value, ret) (*ret = steepness)
...
#define fann_sigmoid_derive(steepness, value, ret) (*ret = (2.0f * steepness * value * (1.0f - value)))
...
#define fann_sigmoid_symmetric_derive(steepness, value, ret) (*ret = steepness * (1.0f - (value*value)))
...
#define fann_gaussian_derive(steepness, value, sum, ret) (*ret = -2.0f * sum * value * steepness * steepness)
...
#define fann_gaussian_symmetric_derive(steepness, value, sum, ret) (*ret = -2.0f * sum * (value+1.0f) * steepness * steepness)
...
#define fann_elliot_derive(steepness, value, sum, ret) (*ret = steepness * 1.0f / (2.0f * (1.0f + fann_abs(sum)) * (1.0f + fann_abs(sum))))
...
#define fann_elliot_symmetric_derive(steepness, value, sum, ret) (*ret = steepness * 1.0f / ((1.0f + fann_abs(sum)) * (1.0f + fann_abs(sum))))
...
#define fann_sin_symmetric_derive(steepness, sum, ret) (*ret = steepness*cos(steepness*sum))

/* FANN_COS_SYMMETRIC */
#define fann_cos_symmetric_real(sum) (cos(sum))
#define fann_cos_symmetric_derive(steepness, sum, ret) (*ret = steepness*-sin(steepness*sum))

/* FANN_SIN */
#define fann_sin_real(sum) (sin(sum)/2.0f+0.5f)
#define fann_sin_derive(steepness, sum, ret) (*ret = steepness*cos(steepness*sum)/2.0f)

/* FANN_COS */
#define fann_cos_real(sum) (cos(sum)/2.0f+0.5f)
#define fann_cos_derive(steepness, sum, ret) (*ret = steepness*-sin(steepness*sum)/2.0f)
