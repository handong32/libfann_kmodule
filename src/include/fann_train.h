...
/* Function: fann_get_activation_steepness
   ...
   This function appears in FANN >= 2.1.0
 */ 
FANN_EXTERNAL void FANN_API fann_get_activation_steepness(struct fann *ann,
							  int layer,
							  int neuron, 
							  fann_type* ret);
...
/* Function: fann_get_bit_fail_limit
   ...
   This function appears in FANN >= 2.0.0.
 */ 
FANN_EXTERNAL void FANN_API fann_get_bit_fail_limit(struct fann *ann, fann_type* ret);
