...
void mlog(double, double*);
void mscalbn(double, int, double*);
void mexp(double, double*);
void mpow(double, double, double*);
void msqrt(double, double*);
void mfabs(double, double*);
void mfloor(double, double*);
void msin(double, double*);
void mcos(double, double*);
